...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--outtype", type=str.lower, choices=["f32", "f16", "bf16", "q8_0", "tq1_0", "tq2_0", "auto"], default="f16",
...
def main() -> None:
    ...
    with torch.inference_mode():
        ...
        model_instance = model_class(dir_model=dir_model, ftype=output_type, fname_out=fname_out.with_suffix('.tmp'),
